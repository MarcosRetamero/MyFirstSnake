...
fuenteGrande = pygame.font.SysFont(None, 40)
fuenteChica = pygame.font.SysFont(None, 30)

#sonidos
eat_sound = pygame.mixer.Sound("C:\Python\Point.mp3")
lose_sound = pygame.mixer.Sound("C:\Python\Lose.mp3")
...
def message(texto, font, color, posx, posy): 
    screen_text = font.render(texto, True, color)
...
def gameLoop():
    ...
    while not game_over:
        ...
        while game_lose == True:
            ...
            message("Game Over!",fuenteGrande,red,0,0)
            message("Presione Esc para salir o cualquier tecla para jugar de nuevo",fuenteChica, red, 0, 40)
            message("Tu puntuación: " + str(puntos),fuenteGrande, white, 0, -80)
            message("High Score: " + str(high_score),fuenteGrande, yellow, 0, -40)
